...
const OurWorkPage = () => {
  ...
  const industries = useMemo(() => {
    const uniqueIndustries = [...new Set(Object.values(ourwork).map(work => work.industry))];
    return ['All Industries', ...uniqueIndustries];
  }, []);

  const filteredWorks = useMemo(() => {
    const works = Object.values(ourwork);
    return selectedIndustry === 'All Industries'
      ? works
      : works.filter(work => work.industry === selectedIndustry);
  }, [selectedIndustry]);
      ...
      >
        <div className="container mx-auto px-4 py-16 text-center">
          <motion.h1
            ...
            animate={{ opacity: 1, y: 0 }}
          >
            Our work that user satisfaction
          </motion.h1>
          <motion.p
